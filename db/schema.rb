...
ActiveRecord::Schema.define(:version => 20120916212058) do
  ...
  create_table "artist_thumbs", :force => true do |t|
    t.string   "image"
    t.integer  "artist_id"
    t.datetime "created_at", :null => false
    t.datetime "updated_at", :null => false
  ...
  add_index "artist_thumbs", ["artist_id"], :name => "index_artist_thumbs_on_artist_id"
